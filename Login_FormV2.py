...
if st.session_state.logged_in:
    ...
    # st.download_button(label="Download File", data=f"This is the sample file. Welcome User {st.session_state.username}", file_name="Mongodb_Cluster_details.txt")
    # st.download_button(label="Download File",file_name="Mongodb_Cluster_details.txt",data="This is the sample text file")

    file_path="C:\\Users\\2328038\\Desktop\\Streamlit\\Login Form\\Mongodb_Cluster_details.txt"
    try:
        with open(file_path, "rb") as file:
            file_data = file.read()
        st.download_button(label="Download File", data=file_data, file_name="Mongodb_Cluster_details.txt")
